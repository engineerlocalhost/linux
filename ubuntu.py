...
apt install qterminal fonts-firacode gnome-tweaks #Installing fonts, qterminal and gnome-tweaks
chsh -s /bin/zsh #Changing the default login shell
#Modifying the zshrc file
rm ~/.zshrc
touch ~/.zshrc #create a new file 
zsh #masuk ke zsh
nano .zshrc #buat file
...
compinit
==========================================
source .zshrc #menjalankan

#Downloading color schemes and themes
